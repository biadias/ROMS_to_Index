...
nmfs_630_640 <-
  st_read('Data/Depth trimmed NMFS shapefiles 300/NMFS630_640.shp')
plot(nmfs_630_640, col = 'brown')

areas <-
  nmfs_630_640 %>% rowwise() %>% mutate(areas = st_area(geometry)) %>% ungroup()
...
area <- (57225003746+62597059226+98582220025)/1000000
