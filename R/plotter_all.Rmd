...
nep_avg_126 <- read.csv('../Data/output_from_loon/nep_avg_wb_ssp126.csv')
nep_sum_126 <- read.csv('../Data/output_from_loon/nep_sum_wb_ssp126.csv')

nep_avg_585 <- read.csv('../Data/output_from_loon/nep_avg_wb_ssp585.csv')
nep_sum_585 <- read.csv('../Data/output_from_loon/nep_sum_wb_ssp585.csv')
```
...
nep_roms <- rbind(nep_avg_hind, nep_sum_hind, nep_avg_hist, nep_sum_hist, nep_avg_126, nep_sum_126, nep_avg_585, nep_sum_585)
```
...
plot_avg <- function(this_var){
  ...
  plot_out <- this_dat %>%
    ggplot(aes(x = as.Date(date), y = value, group = Run, color = Run))+
