---
title: "Viewer of ROMS NEP 10K indexes for GOA-CLIM (2010-2030)"
output:
  html_document:
    toc: yes
    toc_float: yes
...
```{r}
nep_avg_hind <- read.csv('../../Data/output_from_loon/nep_avg_revised_hind_300.csv')
nep_sum_hind <- read.csv('../../Data/output_from_loon/nep_sum_revised_hind_300.csv')

nep_avg_hist <- read.csv('../../Data/output_from_loon/nep_avg_wb_hist_300.csv')
nep_sum_hist <- read.csv('../../Data/output_from_loon/nep_sum_wb_hist_300.csv')
...
nep_avg_245 <- read.csv('../../Data/output_from_loon/nep_avg_wb_ssp245_300.csv')
nep_sum_245 <- read.csv('../../Data/output_from_loon/nep_sum_wb_ssp245_300.csv')
...
window_size <- 24 # averaging every year
...
For trend visualization, 24-month rolling averages are displayed here. Data is in monthly time steps.

```{r avg,fig.height=25,fig.width=10,results='asis'}
...
```{r sum,fig.height=25,fig.width=10,results='asis'}
